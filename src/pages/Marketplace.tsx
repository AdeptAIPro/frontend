...
const Marketplace: React.FC = () => {
  ...
  return (
    <>
    <Helmet>
      <title>Adept-Ai Marketplace</title>
      <meta name="description" content="Explore the AI-powered marketplace of Adept-Ai." />
      <meta property="og:title" content="Adept-Ai Marketplace" />
      <meta property="og:description" content="Explore the AI-powered marketplace of Adept-Ai." />
      <meta property="og:url" content="https://adeptaipro.com/marketplace" />
      <meta property="og:image" content="https://adeptaipro.com/og-image.jpg" />
    </Helmet>
